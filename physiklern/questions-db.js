...
export const EXAM_QUESTIONS = [
  ...
  },
  {
    ...
    solution: {
      ...
      calculation: '- **Luftschall:** Ausbreitung in Luft/Gasen (rein longitudinal).\<br>- **Körperschall:** Ausbreitung in festen Strukturen (Schubwellen, Biegewellen, Longitudinalwellen).\<br>- **Flüssigkeitsschall:** Ausbreitung in z.B. Wasser (praktisch nur longitudinal, wichtig für Sonar).'
    }
  },
  {
    id: 'klausur_10',
